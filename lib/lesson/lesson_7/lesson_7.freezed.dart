...
mixin _$FreezedCar {
 ...
 String get brand; int get year; int get price; Color get color; String? get ownerName;
...
@override
int get hashCode => Object.hash(runtimeType,name,brand,year,price,color,ownerName);

@override
String toString() {
  return 'FreezedCar(name: $name, brand: $brand, year: $year, price: $price, color: $color, ownerName: $ownerName)';
}
...
@useResult
$Res call({
 String name, String brand, int year, int price, Color color, String? ownerName
});
...
/// Create a copy of FreezedCar
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? brand = null,Object? year = null,Object? price = null,Object? color = null,Object? ownerName = freezed,}) {
...
as Color,ownerName: freezed == ownerName ? _self.ownerName : ownerName // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class _FreezedCar implements FreezedCar {
  const _FreezedCar({this.name = "", required this.brand, required this.year, required this.price, required this.color, this.ownerName});
...
/// Create a copy of FreezedCar
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? brand = null,Object? year = null,Object? price = null,Object? color = null,Object? ownerName = freezed,}) {
